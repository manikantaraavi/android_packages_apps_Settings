...
public class DoubleTapPowerFlashlightPreferenceController extends BasePreferenceController
    ...
    private final String SYSTEM_KEY = TORCH_POWER_BUTTON_GESTURE;
    ...
    public int getAvailabilityStatus() {
        return ProtonUtils.deviceHasFlashlight(mContext)
        ...
        if (preference != null) {
            if (preference instanceof ListPreference) {
                ...
                int value = Settings.System.getInt(
                        mContext.getContentResolver(), SYSTEM_KEY, OFF);
                switch (value) {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        Settings.System.putInt(mContext.getContentResolver(),
                SYSTEM_KEY, mTorchPowerButtonValue);
