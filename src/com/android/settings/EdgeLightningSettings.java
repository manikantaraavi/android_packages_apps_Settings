...
import org.proton.support.colorpicker.ColorPickerPreference;
import org.proton.support.preference.CustomSeekBarPreference;
...
public class EdgeLightningSettings extends SettingsPreferenceFragment implements
    ...
    private SystemSettingSwitchPreference mEdgeLightning;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEdgeLightning = (SystemSettingSwitchPreference)
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mEdgeLightning) {
            ...
            return true;
        } else if (preference == mDurationPref) {
